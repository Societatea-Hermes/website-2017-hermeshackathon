...
function subscribeToNewsletterFooter() {
	...
	$.ajax({
		...
		success: function(response) {
			if(response.success == 1) {
				...
				$('#footerEmail').val('');
				$('#emailIconFooter').addClass('icon-email2');
				$('#emailIconFooter').removeClass('icon-spin');
				$('#emailIconFooter').removeClass('icon-line-loader');
			} else {
