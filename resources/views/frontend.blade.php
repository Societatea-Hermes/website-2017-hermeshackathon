...
{{--								</div>--}}
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<input type="text" id="team-theme" name="team-theme" class="form-control input-lg required" placeholder="Which technologies do you intend to use?">
									</div>
								</div>
								<div class="clearfix">&nbsp;</div>
								<div class="row">
					...
					<div class="section nomargin">
                        ...
                        <div class="container clearfix">
                            <div id="oc-clients" class="owl-carousel topmargin image-carousel carousel-widget" data-margin="50" data-loop="true" data-nav="false" data-autoplay="4000" data-pagi="false" data-items-xxs="1" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5">
								...
								<div class="oc-item" style="margin-top: 50px"><a href="https://techntrade.ro/" target="_blank"><img src="/images/partners/2023/tech.png" alt="Tech'n'Trade"></a></div>
								<div class="oc-item" style="margin-top: 50px"><a href="https://metro.digital/" target="_blank"><img src="/images/partners/2023/metro.png" alt="METRO.digital"></a></div>
