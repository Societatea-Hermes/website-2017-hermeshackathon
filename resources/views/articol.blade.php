					...
					<div class="team team-list clearfix">
						<div class="team-desc">
							<div class="team-content">
								...
								<p>
									Cel mai important aspect pe care participanții noștri l-au avut în vedere pe tot parcursul competiției, pentru a duce la capăt proiectul, este organizarea. După cum detaliază și aceștia, fiecare membru al echipei are anumite task-uri, care trebuie bifate, pentru atingerea țelului final. Această împărțire strategică a sarcinilor împreună cu perseverența, motivația și depășirea provocărilor întâlnite pe parcurs, au unit membrii echipei și au uimit jurații.
								</p>
								<div style="text-align: center; padding-bottom: 20px"><img src="/images/pozeHH2021/prez.jpeg" alt="Presenters" style="max-width: 600px; max-height: 400px;"> </div>
								<p>
								...
								<div style="text-align: center; padding-bottom: 20px; justify-content: space-between; display: flex">
									<img src="/images/pozeHH2021/Manuscrito.jpeg" alt="Manuscrito" style="max-width: 550px; max-height: 400px; padding-right:20px ">
									<img src="/images/pozeHH2021/Manuscrito2.jpeg" alt="Manuscrito" style="max-width: 550px; max-height: 400px;">
								</div>
								<p>
									<b>Premiul 2</b> - echipa <i>MMI</i>, pentru aplicația <i>Speak2code</i>, care creează un site pe baza comenzilor vocale
								</p>
								<div style="text-align: center; padding-bottom: 20px; justify-content: space-between; display: flex">
									<img src="/images/pozeHH2021/Speak2code.jpeg" alt="Speak2code" style="max-width: 550px; max-height: 400px; padding-right:20px ">
									<img src="/images/pozeHH2021/Speak2code2.jpeg" alt="Speak2code" style="max-width: 550px; max-height: 400px;">
								</div>
								<p>
								...
								<div style="text-align: center; padding-bottom: 20px; justify-content: space-between; display: flex">
									<img src="/images/pozeHH2021/Polytron.jpeg" alt="Polytron" style="max-width: 550px; max-height: 400px; padding-right:20px ">
									<img src="/images/pozeHH2021/Polytron2.jpeg" alt="Polytron" style="max-width: 550px; max-height: 400px;">
								</div>
								<p>
								...
								<div style="text-align: center; padding-bottom: 20px; justify-content: space-between; display: flex">
									<img src="/images/pozeHH2021/EasyQR.jpeg" alt="EasyQR" style="max-width: 550px; max-height: 400px; padding-right:20px ">
									<img src="/images/pozeHH2021/EasyQR2.jpeg" alt="EasyQR" style="max-width: 550px; max-height: 400px;">
								</div>
								<p>
